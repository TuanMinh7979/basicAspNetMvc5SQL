...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasIndex(e => e.AttributeId, "IX_AttributesPrices_AttributeID");

                entity.HasIndex(e => e.ProductId, "IX_AttributesPrices_ProductID");
            ...
            modelBuilder.Entity<Category>(entity =>
            {
                ...
                entity.Property(e => e.Atb).HasColumnType("character varying");

                entity.Property(e => e.CatName).HasMaxLength(250);

                entity.Property(e => e.Cover).HasMaxLength(255);

                entity.Property(e => e.EditAtb).HasColumnType("character varying");
                ...
                entity.Property(e => e.ShowAtb).HasColumnType("character varying");
            ...
            modelBuilder.Entity<Product>(entity =>
            {
                ...
                entity.Property(e => e.Kv).HasColumnType("character varying");
